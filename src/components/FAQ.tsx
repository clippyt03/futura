  ...
  return (
    <section id="faq" className="relative py-32 md:py-40 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="font-michroma text-5xl md:text-7xl font-bold text-white mb-8 leading-[1.1]">
            {t('faq.headline')}
          </h2>
          <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-3xl mx-auto" style={{ lineHeight: 1.7 }}>
            {t('faq.subtitle')}
          </p>
        </motion.div>
